...
export default function TemplateFour() {
  ...
  // const [resetQimg, setResetQimg] = useState(false);
  ...
  return (
    <div className="container">
      ...
      <br />
      <br />
      <h2 className="mt-3">Certificate Template 4</h2>
      ...
      <div className="row mb-3">
        ...
        <div className="col-sm-5">
          <input
            type="file"
            name="Qimg"
            onChange={handleQimgChange}
            className="form-control"
            key={resetQimg ? "reset" : "qimg"}
            required
          />
        </div>
      </div> */}
