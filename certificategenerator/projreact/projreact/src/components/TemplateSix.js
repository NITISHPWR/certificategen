...
export default function TemplateSix() {
  ...
  const [Simg3, setSimg3] = useState(null);
  ...
  const [Limg3, setLogoimg3] = useState(null);
  const [L3x, setL3x] = useState("");
  ...
  return (
    <div className="container">
      ...
      <br />
      <br />
      <h2 className="mt-3">Certificate Template 6</h2>
      <form onSubmit={handleSubmit}>
        ...
        <div className="row mb-3">
          <label className="col-sm-2 col-form-label">Signature 3 Image:</label>
          <div className="col-sm-5">
            <input
              type="file"
              name="Simg3"
              className="form-control"
              onChange={handleSimg3Change}
              key={resetSimg3 ? "reset" : "simg3"}
              required
            />
          </div>
        </div>
        <div className="row mb-3">
          <label className="col-sm-2 col-form-label">s3x:</label>
          <div className="col-sm-5">
            <input
              type="number"
              name="s3x"
              className="form-control"
              value={s3x}
              onChange={(e) => enforceIntegerInput(e, sets3x)}
              required
            />
          </div>
        </div>
        <div className="row mb-3">
          <label className="col-sm-2 col-form-label">s3y:</label>
          <div className="col-sm-5">
            <input
              type="number"
              name="s3y"
              className="form-control"
              value={s3y}
              onChange={(e) => enforceIntegerInput(e, sets3y)}
              required
            />
          </div>
        </div>
        ...
        <div className="row mb-3">
          <label className="col-sm-2 col-form-label">Logo Image 3:</label>
          <div className="col-sm-5">
            <input
              type="file"
              className="form-control"
              name="logoimg3"
              onChange={handleLogoimgChange3}
              key={resetLogoimg ? "reset" : "logoimg"}
              required
            />
          </div>
        ...
        <div className="row mb-3">
          <label className="col-sm-2 col-form-label">L3x:</label>
          <div className="col-sm-5">
            <input
              type="number"
              name="L3x"
              className="form-control"
              value={L3x}
              onChange={(e) => enforceIntegerInput(e, setL3x)}
              required
            />
          </div>
        </div>
        <div className="row mb-3">
          <label className="col-sm-2 col-form-label">L3y:</label>
          <div className="col-sm-5">
            <input
              type="number"
              name="L3y"
              className="form-control"
              value={L3y}
              onChange={(e) => enforceIntegerInput(e, setL3y)}
              required
            />
          </div>
        </div>
