...
export default function SubHeaderTextboxP({
  onPositionChange,
  ...
  useEffect(() => {
    if (inputRef.current) {
      inputRef.current.style.width = `${subheaderText.length * 8 + 100}px`; // Adjust the factor (10) and initial width (60) based on your preference
