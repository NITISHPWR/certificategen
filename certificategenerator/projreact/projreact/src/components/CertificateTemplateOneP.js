...
import "./CertificateGeneratorP.css"; // Import your CSS file

export default function CertificateTemplateOneP(props) {
  const { data } = props;
  ...
  return (
    <div className="certificate" style={certificateStyle}>
      ...
      />
      {/* <div className="client-id">clientid : {data.clientid}</div>
      <div className="template-id">tid : {data.tid}</div> */}
    </div>
  );
}
