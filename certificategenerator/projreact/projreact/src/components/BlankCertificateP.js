...
import DragTextboxP from "./DragTextboxP";
import "./BlankCertificateP.css";
import HeaderTextboxP from "./HeaderTextboxP";
import SubHeaderTextboxP from "./SubHeaderTextboxP";
import Qr from "./Qr";
import axios from "axios";
export default function BlankCertificateP() {
  ...
  const handleSaveButtonClick = () => {
    ...
    textboxCoordinates.forEach((coordinates, index) => {
      // Create an object for each textbox and add it to the array
      const textarea = {
    ...
    <>
      <div className="certificate-container">
        ...
        <div className="left-div">
          <div
            className={`drop-zone-p ${backgroundImage ? "uploaded" : ""}`}
